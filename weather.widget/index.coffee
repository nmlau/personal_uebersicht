options =
  ...
  region        : "WA"              # default region in case location detection fails
...
style: """
  background: rgba(#000, 0.4) no-repeat 50% 20px
  ...
  top  : 10px
  left : 10px
  width: #{appearance.baseFontSize * 12}px
  ...
  .forecast .temperatures
    font-size: 10px
    font-size  : #{appearance.baseFontSize * .24 * 1.5}px
